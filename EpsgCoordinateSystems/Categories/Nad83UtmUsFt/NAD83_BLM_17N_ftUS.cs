...
{
    internal class NAD83_BLM_17N_ftUS : INad83UsFtCrs
    {
        private const int _srid = 32167;
        ...
        public string EsriWkt =>
            "PROJCS[\"NAD83 / BLM 17N (ftUS)\",GEOGCS[\"GCS_North_American_1983\",DATUM[\"D_North_American_1983\",SPHEROID[\"GRS_1980\",6378137,298.257222101]],PRIMEM[\"Greenwich\",0],UNIT[\"Degree\",0.017453292519943295]],PROJECTION[\"Transverse_Mercator\"],PARAMETER[\"latitude_of_origin\",0],PARAMETER[\"central_meridian\",-81],PARAMETER[\"scale_factor\",0.9996],PARAMETER[\"false_easting\",1640416.67],PARAMETER[\"false_northing\",0],UNIT[\"Foot_US\",0.30480060960121924]]";
        ...
        public BoundingBox BoundingBox => new BoundingBox(47.134, 22.8, -77.67, -84.4);
    }
}