...
{
    public class NAD83_UTM_zone_8N_ftUS : IEpsgCoordinateSystem
    {
        public string Name => "NAD83 / UTM zone 8N (US foot)";
...
public int Srid => -1;
        ...
        public string EsriWkt => "PROJCS[UTM83-8F,GEOGCS[GCS_North_American_1983,DATUM[D_North_American_1983,SPHEROID[GRS_1980,6378137.000,298.25722210],TOWGS84[0.0000,0.0000,0.0000,0.000000,0.000000,0.000000,0.00000000]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[False_Easting,1640416.667],PARAMETER[False_Northing,0.000],PARAMETER[Central_Meridian,-135.00000000000000],PARAMETER[Scale_Factor,0.9996],PARAMETER[Latitude_Of_Origin,0.000],UNIT[Foot_US,0.30480060960122]]";
    }
}