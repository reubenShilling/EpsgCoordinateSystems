...
{
    public class NAD83_UTM_zone_10N : IEpsgCoordinateSystem
    {private const int _srid = 26910; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "NAD83 / UTM zone 10N";
