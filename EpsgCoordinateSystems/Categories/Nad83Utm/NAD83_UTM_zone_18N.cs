...
{
    public class NAD83_UTM_zone_18N : IEpsgCoordinateSystem
    {private const int _srid = 26918; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "NAD83 / UTM zone 18N";
