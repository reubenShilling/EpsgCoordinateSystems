...
{
    public class NAD83_UTM_zone_16N : IEpsgCoordinateSystem
    {private const int _srid = 26916; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "NAD83 / UTM zone 16N";
