...
{
    public class NAD83_Nevada_West_ftUS : IEpsgCoordinateSystem
    {
        ...
        public string EsriWkt =>
            "PROJCS[NAD83 / Nevada West (ft US),GEOGCS[GCS_North_American_1983,DATUM[D_North_American_1983,SPHEROID[GRS_1980,6378137,298.257222101]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,34.75],PARAMETER[central_meridian,-118.5833333333333],PARAMETER[scale_factor,0.9999],PARAMETER[false_easting,2624666.6667],PARAMETER[false_northing,13123333.3333],UNIT[Foot_US,0.30480060960121924]]";
