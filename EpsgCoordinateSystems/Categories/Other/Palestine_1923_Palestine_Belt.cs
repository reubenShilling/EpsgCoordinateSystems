using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 28192; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Palestine 1923 / Palestine Belt,GEOGCS[Palestine 1923,DATUM[D_Palestine_1923,SPHEROID[Clarke_1880_Benoit,6378300.789,293.4663155389811]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,31.73409694444445],PARAMETER[central_meridian,35.21208055555556],PARAMETER[scale_factor,1],PARAMETER[false_easting,170251.555],PARAMETER[false_northing,1126867.909],UNIT[Meter,1]]";
    }
}