using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 24893; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[PSAD56 / Peru east zone,GEOGCS[PSAD56,DATUM[D_Provisional_S_American_1956,SPHEROID[International_1924,6378388,297]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,-9.5],PARAMETER[central_meridian,-70.5],PARAMETER[scale_factor,0.99952992],PARAMETER[false_easting,1324000],PARAMETER[false_northing,1040084.558],UNIT[Meter,1]]";
    }
}