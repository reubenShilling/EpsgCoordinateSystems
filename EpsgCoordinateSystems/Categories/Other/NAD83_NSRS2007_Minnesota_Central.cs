using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 3594; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[NAD83(NSRS2007) / Minnesota Central,GEOGCS[NAD83(NSRS2007),DATUM[D_,SPHEROID[GRS_1980,6378137,298.257222101]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Lambert_Conformal_Conic],PARAMETER[standard_parallel_1,47.05],PARAMETER[standard_parallel_2,45.61666666666667],PARAMETER[latitude_of_origin,45],PARAMETER[central_meridian,-94.25],PARAMETER[false_easting,800000],PARAMETER[false_northing,100000],UNIT[Meter,1]]";
    }
}