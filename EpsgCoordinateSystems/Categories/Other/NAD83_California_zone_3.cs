...
{
    public class NAD83_California_zone_3 : IEpsgCoordinateSystem
    {private const int _srid = 26943; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "NAD83 / California zone 3";
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[NAD83 / California zone 3,GEOGCS[GCS_North_American_1983,DATUM[D_North_American_1983,SPHEROID[GRS_1980,6378137,298.257222101]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Lambert_Conformal_Conic],PARAMETER[standard_parallel_1,38.43333333333333],PARAMETER[standard_parallel_2,37.06666666666667],PARAMETER[latitude_of_origin,36.5],PARAMETER[central_meridian,-120.5],PARAMETER[false_easting,2000000],PARAMETER[false_northing,500000],UNIT[Meter,1]]";
    }
}