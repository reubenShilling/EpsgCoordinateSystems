using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 3850; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[SWEREF99 / RT90 5 gon O emulation,GEOGCS[SWEREF99,DATUM[D_SWEREF99,SPHEROID[GRS_1980,6378137.0,298.257222101]],PRIMEM[Greenwich,0.0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse Mercator],PARAMETER[central_meridian,22.556333333333342],PARAMETER[latitude_of_origin,0.0],PARAMETER[scale_factor,1.0000049],PARAMETER[false_easting,1500121.846],PARAMETER[false_northing,-672.557],UNIT[m,1.0]]";
    }
}