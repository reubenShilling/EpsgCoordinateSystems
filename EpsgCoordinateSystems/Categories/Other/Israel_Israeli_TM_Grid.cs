using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 2039; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Israel / Israeli TM Grid,GEOGCS[Israel,DATUM[D_Israel,SPHEROID[GRS_1980,6378137,298.257222101]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,31.73439361111111],PARAMETER[central_meridian,35.20451694444445],PARAMETER[scale_factor,1.0000067],PARAMETER[false_easting,219529.584],PARAMETER[false_northing,626907.39],UNIT[Meter,1]]";
    }
}