using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 3448; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[JAD2001 / Jamaica Metric Grid,GEOGCS[JAD2001,DATUM[D_,SPHEROID[WGS_1984,6378137,298.257223563]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Lambert_Conformal_Conic],PARAMETER[latitude_of_origin,18],PARAMETER[central_meridian,-77],PARAMETER[scale_factor,1],PARAMETER[false_easting,750000],PARAMETER[false_northing,650000],UNIT[Meter,1]]";
    }
}