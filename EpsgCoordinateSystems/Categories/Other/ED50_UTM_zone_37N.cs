...
{
    public class ED50_UTM_zone_37N : IEpsgCoordinateSystem
    {private const int _srid = 23037; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "ED50 / UTM zone 37N";
