...
{
    public class NAD83_Alaska_Albers : IEpsgCoordinateSystem
    {private const int _srid = 3338; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "NAD83 / Alaska Albers";
