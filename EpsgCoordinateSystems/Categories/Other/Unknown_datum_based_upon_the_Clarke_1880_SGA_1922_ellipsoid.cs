using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 4014; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "GEOGCS[Unknown datum based upon the Clarke 1880 (SGA 1922) ellipsoid,DATUM[D_Clarke_1880_SGA,SPHEROID[Clarke_1880_SGA_1922,6378249.2,293.46598]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]]";
    }
}