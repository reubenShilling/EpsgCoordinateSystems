...
{
    public class Hartebeesthoek94_Lo15 : IEpsgCoordinateSystem
    {private const int _srid = 2046; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "Hartebeesthoek94 / Lo15";
