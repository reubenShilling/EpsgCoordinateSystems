using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 3844; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Pulkovo 1942(58) / Stereo70,GEOGCS[Pulkovo 1942(58),DATUM[D_Pulkovo 1942(58),SPHEROID[Krassowsky_1940,6378245.0,298.3]],PRIMEM[Greenwich,0.0],UNIT[Degree,0.017453292519943295]],PROJECTION[Oblique Stereographic],PARAMETER[central_meridian,25.0],PARAMETER[latitude_of_origin,46.0],PARAMETER[scale_factor,0.99975],PARAMETER[false_easting,500000.0],PARAMETER[false_northing,500000.0],UNIT[m,1.0]]";
    }
}