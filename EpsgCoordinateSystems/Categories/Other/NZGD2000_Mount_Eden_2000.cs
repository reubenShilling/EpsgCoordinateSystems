...
{
    public class NZGD2000_Mount_Eden_2000 : IEpsgCoordinateSystem
    {private const int _srid = 2105; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "NZGD2000 / Mount Eden 2000";
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[NZGD2000 / Mount Eden 2000,GEOGCS[NZGD2000,DATUM[D_NZGD_2000,SPHEROID[GRS_1980,6378137,298.257222101]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,-36.87972222222222],PARAMETER[central_meridian,174.7641666666667],PARAMETER[scale_factor,0.9999],PARAMETER[false_easting,400000],PARAMETER[false_northing,800000],UNIT[Meter,1]]";
    }
}