using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 3816; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[NAD83(NSRS2007) / Mississippi TM,GEOGCS[NAD83(NSRS2007),DATUM[D_NAD83 (National Spatial Reference System 2007),SPHEROID[GRS_1980,6378137.0,298.257222101]],PRIMEM[Greenwich,0.0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse Mercator],PARAMETER[central_meridian,-89.75],PARAMETER[latitude_of_origin,32.5],PARAMETER[scale_factor,0.9998335],PARAMETER[false_easting,500000.0],PARAMETER[false_northing,1300000.0],UNIT[m,1.0]]";
    }
}