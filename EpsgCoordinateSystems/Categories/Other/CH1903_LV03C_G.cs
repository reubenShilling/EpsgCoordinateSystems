using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 21782; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[CH1903 / LV03C-G,GEOGCS[CH1903,DATUM[D_CH1903,SPHEROID[Bessel_1841,6377397.155,299.1528128]],PRIMEM[Greenwich,0.0],UNIT[Degree,0.017453292519943295]],PROJECTION[Oblique Mercator],PARAMETER[longitude_of_center,7.439583333333333],PARAMETER[latitude_of_center,46.952405555555565],PARAMETER[azimuth,90.0],PARAMETER[scale_factor,1.0],PARAMETER[false_easting,0.0],PARAMETER[false_northing,0.0],PARAMETER[rectified_grid_angle,90.0],UNIT[m,1.0]]";
    }
}