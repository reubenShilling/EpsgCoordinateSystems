...
{
    public class ED50_UTM_zone_36N : IEpsgCoordinateSystem
    {private const int _srid = 23036; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "ED50 / UTM zone 36N";
