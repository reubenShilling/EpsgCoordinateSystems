using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 3846; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[SWEREF99 / RT90 5 gon V emulation,GEOGCS[SWEREF99,DATUM[D_SWEREF99,SPHEROID[GRS_1980,6378137.0,298.257222101]],PRIMEM[Greenwich,0.0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse Mercator],PARAMETER[central_meridian,13.556266666666666],PARAMETER[latitude_of_origin,0.0],PARAMETER[scale_factor,1.0000058],PARAMETER[false_easting,1500044.695],PARAMETER[false_northing,-667.13],UNIT[m,1.0]]";
    }
}