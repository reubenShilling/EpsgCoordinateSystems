...
{
    public class Korean_1985_Korea_Central_Belt : IEpsgCoordinateSystem
    {private const int _srid = 2097; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "Korean 1985 / Korea Central Belt";
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Korean 1985 / Korea Central Belt,GEOGCS[Korean 1985,DATUM[D_Korean_Datum_1985,SPHEROID[Bessel_1841,6377397.155,299.1528128]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,38],PARAMETER[central_meridian,127],PARAMETER[scale_factor,1],PARAMETER[false_easting,200000],PARAMETER[false_northing,500000],UNIT[Meter,1]]";
    }
}