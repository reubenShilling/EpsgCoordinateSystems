...
{
    public class NAD83_West_Virginia_South : IEpsgCoordinateSystem
    {private const int _srid = 32151; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "NAD83 / West Virginia South";
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[NAD83 / West Virginia South,GEOGCS[GCS_North_American_1983,DATUM[D_North_American_1983,SPHEROID[GRS_1980,6378137,298.257222101]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Lambert_Conformal_Conic],PARAMETER[standard_parallel_1,38.88333333333333],PARAMETER[standard_parallel_2,37.48333333333333],PARAMETER[latitude_of_origin,37],PARAMETER[central_meridian,-81],PARAMETER[false_easting,600000],PARAMETER[false_northing,0],UNIT[Meter,1]]";
    }
}