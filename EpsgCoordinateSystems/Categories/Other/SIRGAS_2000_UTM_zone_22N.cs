...
{
    public class SIRGAS_2000_UTM_zone_22N : IEpsgCoordinateSystem
    {private const int _srid = 31976; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "SIRGAS 2000 / UTM zone 22N";
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[SIRGAS 2000 / UTM zone 22N,GEOGCS[SIRGAS 2000,DATUM[D_SIRGAS_2000,SPHEROID[GRS_1980,6378137,298.257222101]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,0],PARAMETER[central_meridian,-51],PARAMETER[scale_factor,0.9996],PARAMETER[false_easting,500000],PARAMETER[false_northing,0],UNIT[Meter,1]]";
    }
}