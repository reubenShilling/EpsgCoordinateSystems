...
{
    public class WGS_72_UTM_zone_21S : IEpsgCoordinateSystem
    {private const int _srid = 32321; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "WGS 72 / UTM zone 21S";
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[WGS 72 / UTM zone 21S,GEOGCS[WGS 72,DATUM[D_WGS_1972,SPHEROID[WGS_1972,6378135,298.26]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,0],PARAMETER[central_meridian,-57],PARAMETER[scale_factor,0.9996],PARAMETER[false_easting,500000],PARAMETER[false_northing,10000000],UNIT[Meter,1]]";
    }
}