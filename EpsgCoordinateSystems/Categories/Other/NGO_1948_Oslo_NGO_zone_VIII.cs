...
{
    public class NGO_1948_Oslo_NGO_zone_VIII : IEpsgCoordinateSystem
    {private const int _srid = 27398; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "NGO 1948 (Oslo) / NGO zone VIII";
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[NGO 1948 (Oslo) / NGO zone VIII,GEOGCS[NGO 1948 (Oslo),DATUM[D_NGO_1948,SPHEROID[Bessel_Modified,6377492.018,299.1528128]],PRIMEM[Oslo,10.72291666666667],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,58],PARAMETER[central_meridian,18.33333333333333],PARAMETER[scale_factor,1],PARAMETER[false_easting,0],PARAMETER[false_northing,0],UNIT[Meter,1]]";
    }
}