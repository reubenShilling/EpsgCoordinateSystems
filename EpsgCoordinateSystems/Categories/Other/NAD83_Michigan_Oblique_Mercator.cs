using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 3078; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[NAD83 / Michigan Oblique Mercator,GEOGCS[GCS_North_American_1983,DATUM[D_North_American_1983,SPHEROID[GRS_1980,6378137,298.257222101]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Hotine_Oblique_Mercator_Azimuth_Natural_Origin],PARAMETER[latitude_of_center,45.30916666666666],PARAMETER[longitude_of_center,-86],PARAMETER[azimuth,337.25556],PARAMETER[rectified_grid_angle,337.25556],PARAMETER[scale_factor,0.9996],PARAMETER[false_easting,2546731.496],PARAMETER[false_northing,-4354009.816],UNIT[Meter,1]]";
    }
}