using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 3161; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[NAD83 / Ontario MNR Lambert,GEOGCS[GCS_North_American_1983,DATUM[D_North_American_1983,SPHEROID[GRS_1980,6378137,298.257222101]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Lambert_Conformal_Conic],PARAMETER[standard_parallel_1,44.5],PARAMETER[standard_parallel_2,53.5],PARAMETER[latitude_of_origin,0],PARAMETER[central_meridian,-85],PARAMETER[false_easting,930000],PARAMETER[false_northing,6430000],UNIT[Meter,1]]";
    }
}