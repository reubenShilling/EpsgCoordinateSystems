...
{
    public class CH1903_LV95 : IEpsgCoordinateSystem
    {private const int _srid = 2056; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "CH1903+ / LV95";
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[CH1903+ / LV95,GEOGCS[CH1903+,DATUM[D_CH1903,SPHEROID[Bessel_1841,6377397.155,299.1528128]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Hotine_Oblique_Mercator_Azimuth_Center],PARAMETER[latitude_of_center,46.95240555555556],PARAMETER[longitude_of_center,7.439583333333333],PARAMETER[azimuth,90],PARAMETER[scale_factor,1],PARAMETER[false_easting,2600000],PARAMETER[false_northing,1200000],UNIT[Meter,1]]";
    }
}