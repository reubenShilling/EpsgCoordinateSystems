using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 2047; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
