using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 7405; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "COMPD_CS[OSGB36 / British National Grid + ODN,PROJCS[OSGB 1936 / British National Grid,GEOGCS[OSGB 1936,DATUM[D_OSGB 1936,SPHEROID[Airy_1830,6377563.396,299.3249646]],PRIMEM[Greenwich,0.0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse Mercator],PARAMETER[central_meridian,-2.0],PARAMETER[latitude_of_origin,49.0],PARAMETER[scale_factor,0.9996012717],PARAMETER[false_easting,400000.0],PARAMETER[false_northing,-100000.0],UNIT[m,1.0]],VERT_CS[Newlyn,VERT_DATUM[Ordnance Datum Newlyn,2005],UNIT[m,1.0]]]";
    }
}