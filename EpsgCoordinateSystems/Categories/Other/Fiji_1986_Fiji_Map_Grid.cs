using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 3460; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Fiji 1986 / Fiji Map Grid,GEOGCS[Fiji 1986,DATUM[D_Fiji_1986,SPHEROID[WGS_1972,6378135,298.26]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,-17],PARAMETER[central_meridian,178.75],PARAMETER[scale_factor,0.99985],PARAMETER[false_easting,2000000],PARAMETER[false_northing,4000000],UNIT[Meter,1]]";
    }
}