...
{
    public class NAD_Michigan_Michigan_East : IEpsgCoordinateSystem
    {private const int _srid = 26801; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "NAD Michigan / Michigan East";
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[NAD Michigan / Michigan East,GEOGCS[NAD27 Michigan,DATUM[D_North_American_Michigan,SPHEROID[Clarke_1866_Michigan,6378450.047548896,294.9786971646747]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,41.5],PARAMETER[central_meridian,-83.66666666666667],PARAMETER[scale_factor,0.999942857],PARAMETER[false_easting,500000],PARAMETER[false_northing,0],UNIT[Foot_US,0.30480060960121924]]";
    }
}