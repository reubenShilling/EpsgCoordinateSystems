using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 20822; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
