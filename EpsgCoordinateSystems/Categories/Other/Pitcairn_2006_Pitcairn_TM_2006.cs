using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 3783; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Pitcairn 2006 / Pitcairn TM 2006,GEOGCS[Pitcairn 2006,DATUM[D_Pitcairn_2006,SPHEROID[WGS_1984,6378137,298.257223563]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,-25.06855261111111],PARAMETER[central_meridian,-130.1129671111111],PARAMETER[scale_factor,1],PARAMETER[false_easting,14200],PARAMETER[false_northing,15500],UNIT[Meter,1]]";
    }
}