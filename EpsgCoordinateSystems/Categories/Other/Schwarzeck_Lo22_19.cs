...
{
    public class Schwarzeck_Lo22_19 : IEpsgCoordinateSystem
    {private const int _srid = 29379; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "Schwarzeck / Lo22/19";
