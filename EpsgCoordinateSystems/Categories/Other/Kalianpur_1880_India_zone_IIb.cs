using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 24382; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Kalianpur 1880 / India zone IIb,GEOGCS[Kalianpur 1880,DATUM[D_Kalianpur_1880,SPHEROID[Everest_1830_Definition,6377299.36559538,300.8017255433612]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Lambert_Conformal_Conic],PARAMETER[latitude_of_origin,26],PARAMETER[central_meridian,90],PARAMETER[scale_factor,0.99878641],PARAMETER[false_easting,3000000],PARAMETER[false_northing,1000000],UNIT[Indian yard,0.9143985307444408]]";
    }
}