...
{
    public class WGS_72BE_UTM_zone_43S : IEpsgCoordinateSystem
    {private const int _srid = 32543; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "WGS 72BE / UTM zone 43S";
