...
{
    public class ETRS89_Portugal_TM06 : IEpsgCoordinateSystem
    {private const int _srid = 3763; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "ETRS89 / Portugal TM06";
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[ETRS89 / Portugal TM06,GEOGCS[ETRS89,DATUM[D_ETRS_1989,SPHEROID[GRS_1980,6378137,298.257222101]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,39.66825833333333],PARAMETER[central_meridian,-8.133108333333334],PARAMETER[scale_factor,1],PARAMETER[false_easting,0],PARAMETER[false_northing,0],UNIT[Meter,1]]";
    }
}