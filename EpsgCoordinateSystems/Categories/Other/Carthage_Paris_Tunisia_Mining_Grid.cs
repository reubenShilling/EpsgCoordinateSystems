using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 22300; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Carthage (Paris) / Tunisia Mining Grid,GEOGCS[Carthage (Paris),DATUM[D_Carthage,SPHEROID[Clarke_1880_IGN,6378249.2,293.4660212936269]],PRIMEM[Paris,2.33722917],UNIT[grad,0.01570796326794897]],PROJECTION[Tunisia_Mining_Grid],PARAMETER[latitude_of_origin,38.81973],PARAMETER[central_meridian,7.83445],PARAMETER[false_easting,270],PARAMETER[false_northing,582],UNIT[kilometre,1000]]";
    }
}