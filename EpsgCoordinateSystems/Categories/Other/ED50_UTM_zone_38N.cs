...
{
    public class ED50_UTM_zone_38N : IEpsgCoordinateSystem
    {private const int _srid = 23038; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "ED50 / UTM zone 38N";
