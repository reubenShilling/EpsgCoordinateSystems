...
{
    public class Xian_1980_3_degree_Gauss_Kruger_zone_36 : IEpsgCoordinateSystem
    {private const int _srid = 2360; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "Xian 1980 / 3-degree Gauss-Kruger zone 36";
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Xian 1980 / 3-degree Gauss-Kruger zone 36,GEOGCS[Xian 1980,DATUM[D_Xian_1980,SPHEROID[Xian_1980,6378140,298.257]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,0],PARAMETER[central_meridian,108],PARAMETER[scale_factor,1],PARAMETER[false_easting,36500000],PARAMETER[false_northing,0],UNIT[Meter,1]]";
    }
}