using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 23879; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
