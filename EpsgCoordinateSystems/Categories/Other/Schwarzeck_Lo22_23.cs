...
{
    public class Schwarzeck_Lo22_23 : IEpsgCoordinateSystem
    {private const int _srid = 29383; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "Schwarzeck / Lo22/23";
