using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 3347; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[NAD83 / Statistics Canada Lambert,GEOGCS[GCS_North_American_1983,DATUM[D_North_American_1983,SPHEROID[GRS_1980,6378137,298.257222101]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Lambert_Conformal_Conic],PARAMETER[standard_parallel_1,49],PARAMETER[standard_parallel_2,77],PARAMETER[latitude_of_origin,63.390675],PARAMETER[central_meridian,-91.86666666666666],PARAMETER[false_easting,6200000],PARAMETER[false_northing,3000000],UNIT[Meter,1]]";
    }
}