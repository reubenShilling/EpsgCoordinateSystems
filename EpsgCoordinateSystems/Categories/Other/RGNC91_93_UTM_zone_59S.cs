using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 3171; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
