using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 3795; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[NAD27 / Cuba Norte,GEOGCS[GCS_North_American_1927,DATUM[D_North_American_1927,SPHEROID[Clarke_1866,6378206.4,294.9786982138982]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Lambert_Conformal_Conic],PARAMETER[standard_parallel_1,23],PARAMETER[standard_parallel_2,21.7],PARAMETER[latitude_of_origin,22.35],PARAMETER[central_meridian,-81],PARAMETER[false_easting,500000],PARAMETER[false_northing,280296.016],UNIT[Meter,1]]";
    }
}