...
{
    public class ED50_UTM_zone_34N : IEpsgCoordinateSystem
    {private const int _srid = 23034; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "ED50 / UTM zone 34N";
