...
{
    public class WGS_84_UTM_zone_33S : IEpsgCoordinateSystem
    {private const int _srid = 32733; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "WGS 84 / UTM zone 33S";
