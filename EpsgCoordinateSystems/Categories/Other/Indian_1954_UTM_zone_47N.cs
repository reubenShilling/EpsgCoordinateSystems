...
{
    public class Indian_1954_UTM_zone_47N : IEpsgCoordinateSystem
    {private const int _srid = 23947; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "Indian 1954 / UTM zone 47N";
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Indian 1954 / UTM zone 47N,GEOGCS[Indian 1954,DATUM[D_Indian_1954,SPHEROID[Everest_1830_1937_Adjustment,6377276.345,300.8017]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,0],PARAMETER[central_meridian,99],PARAMETER[scale_factor,0.9996],PARAMETER[false_easting,500000],PARAMETER[false_northing,0],UNIT[Meter,1]]";
    }
}