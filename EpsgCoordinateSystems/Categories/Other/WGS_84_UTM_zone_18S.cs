...
{
    public class WGS_84_UTM_zone_18S : IEpsgCoordinateSystem
    {private const int _srid = 32718; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "WGS 84 / UTM zone 18S";
