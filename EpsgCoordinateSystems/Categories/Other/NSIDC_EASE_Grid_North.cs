...
{
    public class NSIDC_EASE_Grid_North : IEpsgCoordinateSystem
    {private const int _srid = 3408; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "NSIDC EASE-Grid North";
