using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 28600; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Qatar 1974 / Qatar National Grid,GEOGCS[Qatar 1974,DATUM[D_Qatar,SPHEROID[International_1924,6378388,297]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,24.45],PARAMETER[central_meridian,51.21666666666667],PARAMETER[scale_factor,0.99999],PARAMETER[false_easting,200000],PARAMETER[false_northing,300000],UNIT[Meter,1]]";
    }
}