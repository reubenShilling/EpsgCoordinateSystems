...
{
    public class Pulkovo_1942_Gauss_Kruger_zone_6 : IEpsgCoordinateSystem
    {private const int _srid = 28406; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "Pulkovo 1942 / Gauss-Kruger zone 6";
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Pulkovo 1942 / Gauss-Kruger zone 6,GEOGCS[Pulkovo 1942,DATUM[D_Pulkovo_1942,SPHEROID[Krassowsky_1940,6378245,298.3]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,0],PARAMETER[central_meridian,33],PARAMETER[scale_factor,1],PARAMETER[false_easting,6500000],PARAMETER[false_northing,0],UNIT[Meter,1]]";
    }
}