using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 21292; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Barbados 1938 / Barbados National Grid,GEOGCS[Barbados 1938,DATUM[D_Barbados_1938,SPHEROID[Clarke_1880_RGS,6378249.145,293.465]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,13.17638888888889],PARAMETER[central_meridian,-59.55972222222222],PARAMETER[scale_factor,0.9999986],PARAMETER[false_easting,30000],PARAMETER[false_northing,75000],UNIT[Meter,1]]";
    }
}