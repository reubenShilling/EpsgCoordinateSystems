...
{
    public class JGD2000_UTM_zone_53N : IEpsgCoordinateSystem
    {private const int _srid = 3099; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "JGD2000 / UTM zone 53N";
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[JGD2000 / UTM zone 53N,GEOGCS[JGD2000,DATUM[D_JGD_2000,SPHEROID[GRS_1980,6378137,298.257222101]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,0],PARAMETER[central_meridian,135],PARAMETER[scale_factor,0.9996],PARAMETER[false_easting,500000],PARAMETER[false_northing,0],UNIT[Meter,1]]";
    }
}