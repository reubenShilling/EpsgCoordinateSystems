using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 27563; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[NTF (Paris) / Lambert Sud France,GEOGCS[NTF (Paris),DATUM[D_NTF,SPHEROID[Clarke_1880_IGN,6378249.2,293.4660212936269]],PRIMEM[Paris,2.33722917],UNIT[grad,0.01570796326794897]],PROJECTION[Lambert_Conformal_Conic],PARAMETER[latitude_of_origin,49],PARAMETER[central_meridian,0],PARAMETER[scale_factor,0.999877499],PARAMETER[false_easting,600000],PARAMETER[false_northing,200000],UNIT[Meter,1]]";
    }
}