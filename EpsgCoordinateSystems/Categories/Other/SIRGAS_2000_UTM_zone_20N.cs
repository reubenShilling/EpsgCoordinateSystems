...
{
    public class SIRGAS_2000_UTM_zone_20N : IEpsgCoordinateSystem
    {private const int _srid = 31974; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "SIRGAS 2000 / UTM zone 20N";
