using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 24500; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Kertau 1968 / Singapore Grid,GEOGCS[Kertau 1968,DATUM[D_Kertau,SPHEROID[Everest_1830_Modified,6377304.063,300.8017]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Cassini],PARAMETER[latitude_of_origin,1.287646666666667],PARAMETER[central_meridian,103.8530022222222],PARAMETER[false_easting,30000],PARAMETER[false_northing,30000],UNIT[Meter,1]]";
    }
}