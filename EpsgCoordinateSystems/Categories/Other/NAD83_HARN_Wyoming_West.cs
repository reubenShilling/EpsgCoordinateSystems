...
{
    public class NAD83_HARN_Wyoming_West : IEpsgCoordinateSystem
    {private const int _srid = 2865; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "NAD83(HARN) / Wyoming West";
