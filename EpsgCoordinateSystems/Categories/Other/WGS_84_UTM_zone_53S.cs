...
{
    public class WGS_84_UTM_zone_53S : IEpsgCoordinateSystem
    {private const int _srid = 32753; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "WGS 84 / UTM zone 53S";
