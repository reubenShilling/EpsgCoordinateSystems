...
{
    public class WGS_84_UTM_zone_22N : IEpsgCoordinateSystem
    {private const int _srid = 32622; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "WGS 84 / UTM zone 22N";
