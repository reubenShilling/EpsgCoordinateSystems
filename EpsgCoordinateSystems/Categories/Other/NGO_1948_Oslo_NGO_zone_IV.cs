using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 27394; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[NGO 1948 (Oslo) / NGO zone IV,GEOGCS[NGO 1948 (Oslo),DATUM[D_NGO_1948,SPHEROID[Bessel_Modified,6377492.018,299.1528128]],PRIMEM[Oslo,10.72291666666667],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,58],PARAMETER[central_meridian,2.5],PARAMETER[scale_factor,1],PARAMETER[false_easting,0],PARAMETER[false_northing,0],UNIT[Meter,1]]";
    }
}