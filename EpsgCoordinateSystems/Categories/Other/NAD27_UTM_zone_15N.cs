...
{
    public class NAD27_UTM_zone_15N : IEpsgCoordinateSystem
    {private const int _srid = 26715; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "NAD27 / UTM zone 15N";
