using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 26812; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[NAD Michigan / Michigan Central,GEOGCS[NAD27 Michigan,DATUM[D_North_American_Michigan,SPHEROID[Clarke_1866_Michigan,6378450.047548896,294.9786971646747]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Lambert_Conformal_Conic],PARAMETER[standard_parallel_1,44.18333333333333],PARAMETER[standard_parallel_2,45.7],PARAMETER[latitude_of_origin,43.31666666666667],PARAMETER[central_meridian,-84.33333333333333],PARAMETER[false_easting,2000000],PARAMETER[false_northing,0],UNIT[Foot_US,0.30480060960121924]]";
    }
}