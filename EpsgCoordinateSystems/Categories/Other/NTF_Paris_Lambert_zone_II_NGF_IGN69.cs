using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 7412; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "COMPD_CS[NTF (Paris) / Lambert zone II + NGF IGN69,PROJCS[NTF (Paris) / Lambert zone II,GEOGCS[NTF (Paris),DATUM[D_Nouvelle Triangulation Francaise (Paris),SPHEROID[Clarke_1880_IGN,6378249.2,293.4660212936269]],PRIMEM[Paris,2.5969213],UNIT[grade,0.015707963267948967]],PROJECTION[Lambert Conic Conformal (1SP)],PARAMETER[central_meridian,0.0],PARAMETER[latitude_of_origin,52.0],PARAMETER[scale_factor,0.99987742],PARAMETER[false_easting,600000.0],PARAMETER[false_northing,2200000.0],UNIT[m,1.0]],VERT_CS[NGF Lallemand,VERT_DATUM[Nivellement General de la France - Lallemand,2005],UNIT[m,1.0]]]";
    }
}