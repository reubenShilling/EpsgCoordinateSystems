using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 3109; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[ETRS89 / Jersey Transverse Mercator,GEOGCS[ETRS89,DATUM[D_ETRS_1989,SPHEROID[GRS_1980,6378137,298.257222101]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,49.225],PARAMETER[central_meridian,-2.135],PARAMETER[scale_factor,0.9999999],PARAMETER[false_easting,40000],PARAMETER[false_northing,70000],UNIT[Meter,1]]";
    }
}