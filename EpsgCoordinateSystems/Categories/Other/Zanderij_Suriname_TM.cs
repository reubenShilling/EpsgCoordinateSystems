...
{
    public class Zanderij_Suriname_TM : IEpsgCoordinateSystem
    {private const int _srid = 31171; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "Zanderij / Suriname TM";
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Zanderij / Suriname TM,GEOGCS[Zanderij,DATUM[D_Zanderij,SPHEROID[International_1924,6378388,297]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,0],PARAMETER[central_meridian,-55.68333333333333],PARAMETER[scale_factor,0.9999],PARAMETER[false_easting,500000],PARAMETER[false_northing,0],UNIT[Meter,1]]";
    }
}