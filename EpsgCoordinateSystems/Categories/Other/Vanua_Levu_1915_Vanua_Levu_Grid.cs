using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 3139; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Vanua Levu 1915 / Vanua Levu Grid,GEOGCS[Vanua Levu 1915,DATUM[D_,SPHEROID[Clarke_1880_international_foot,6378306.3696,293.4663076556361]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],UNIT[link,0.201168]]";
    }
}