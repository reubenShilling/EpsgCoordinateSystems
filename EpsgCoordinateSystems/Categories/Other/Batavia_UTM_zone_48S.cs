using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 21148; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
