using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 3827; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[TWD67 / TM2 zone 119,GEOGCS[TWD67,DATUM[D_Taiwan Datum 1967,SPHEROID[GRS_1967_Modified,6378160.0,298.25]],PRIMEM[Greenwich,0.0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse Mercator],PARAMETER[central_meridian,119.0],PARAMETER[latitude_of_origin,0.0],PARAMETER[scale_factor,0.9999],PARAMETER[false_easting,250000.0],PARAMETER[false_northing,0.0],UNIT[m,1.0]]";
    }
}