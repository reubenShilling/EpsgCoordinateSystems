...
{
    public class NAD27_UTM_zone_16N : IEpsgCoordinateSystem
    {private const int _srid = 26716; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "NAD27 / UTM zone 16N";
