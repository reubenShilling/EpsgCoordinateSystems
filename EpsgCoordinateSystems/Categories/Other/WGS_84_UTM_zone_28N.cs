...
{
    public class WGS_84_UTM_zone_28N : IEpsgCoordinateSystem
    {private const int _srid = 32628; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
        public string Name => "WGS 84 / UTM zone 28N";
