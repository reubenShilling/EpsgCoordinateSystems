using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 25000; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "PROJCS[Leigon / Ghana Metre Grid,GEOGCS[Leigon,DATUM[D_Leigon,SPHEROID[Clarke_1880_RGS,6378249.145,293.465]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]],PROJECTION[Transverse_Mercator],PARAMETER[latitude_of_origin,4.666666666666667],PARAMETER[central_meridian,-1],PARAMETER[scale_factor,0.99975],PARAMETER[false_easting,274319.51],PARAMETER[false_northing,0],UNIT[Meter,1]]";
    }
}