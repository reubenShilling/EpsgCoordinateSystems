using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Other
{
    ...
    {private const int _srid = 4016; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
...
public int Srid => _srid;
        ...
        public string EsriWkt => "GEOGCS[Unknown datum based upon the Everest 1830 (1967 Definition) ellipsoid,DATUM[D_Everest_Def_1967,SPHEROID[Everest_1830_1967_Definition,6377298.556,300.8017]],PRIMEM[Greenwich,0],UNIT[Degree,0.017453292519943295]]";
    }
}