using DotSpatial.Projections;namespace EpsgCoordinateSystems.Categories.Nad83HarnUsFt
{
    ...
    {private const int _srid = 3444; public ProjectionInfo ProjectionInfo => ProjectionInfo.FromEpsgCode(_srid);
